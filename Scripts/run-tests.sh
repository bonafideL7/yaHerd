...
# Reuse the production Debug build generated by verify-concurrency.sh. Xcode manages
# the simulator boot/test clone itself; pre-booting the base simulator duplicates work
# and can spend minutes in first-boot data migration on hosted runners.
