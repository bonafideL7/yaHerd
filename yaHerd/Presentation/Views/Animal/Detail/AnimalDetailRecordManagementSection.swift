...
struct AnimalDetailRecordManagementSection: View {
    ...
    let onRestore: () -> Void
    let onArchive: () -> Void
    let onPreparePermanentDelete: () -> AnimalDetailSnapshot?
    let onDelete: () -> Void

    @State private var showingArchiveConfirmation = false
    @State private var permanentDeleteReviewDetail: AnimalDetailSnapshot?
    ...
    private var permanentDeleteSection: some View {
        Section {
            Button("Permanently Delete", role: .destructive) {
                permanentDeleteReviewDetail = onPreparePermanentDelete()
            }
            .disabledWhenDataReadOnly()
            .sheet(item: $permanentDeleteReviewDetail) { reviewDetail in
            ...
            List {
                ...
                Section("Related Records Kept Without This Animal") {
                    impactRow(
                        ...
                        detail: "Parent and offspring links are cleared, including links to archived offspring"
                    )
                    impactRow(
