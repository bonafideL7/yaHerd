...
final class DashboardViewModel {
    ...
    func loadIfNeeded(
        ...
        using readModel: any DashboardReadModel
    ) async {
        guard !hasLoaded else { return }
        await load(configuration: configuration, using: readModel)
    }
    ...
    func load(
        ...
        do {
            snapshot = try await LoadDashboardUseCase(readModel: readModel)
