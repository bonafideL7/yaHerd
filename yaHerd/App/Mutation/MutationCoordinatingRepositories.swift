...
@MainActor
struct LocalDataWritePolicy {
    enum WriteError: LocalizedError {
        case readOnlyRecovery

        var errorDescription: String? {
            "Changes are disabled while yaHerd is running in recovery mode."
        }
    }
    ...
    func validateCanWrite() throws {
        guard canWrite else {
            throw WriteError.readOnlyRecovery
        }
    }
}

@MainActor
struct MutationPublishingAnimalRepository: AnimalRepository {
...
@MainActor
struct MutationPublishingPastureRepository: PastureRepository {
...
@MainActor
final class MutationPublishingTagColorRepository: TagColorRepository {
...
@MainActor
struct MutationPublishingWorkingRepository: WorkingRepository {
...
struct MutationPublishingSampleDataSeeder: SampleDataSeeding {
    ...
    func seedSampleDataIfNeeded() {
        guard writePolicy.canWrite else { return }
