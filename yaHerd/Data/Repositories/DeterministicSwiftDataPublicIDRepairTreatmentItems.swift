            ...
            for index in template.items.indices {
                ...
                locations.append(
                    TreatmentItemLocation(
                        ...
                        ownerHerdPublicID: template.collaborationHerdPublicID,
            ...
            for index in session.protocolItems.indices {
                ...
                locations.append(
                    TreatmentItemLocation(
                        ...
                        ownerHerdPublicID: session.collaborationHerdPublicID,
                        ownerSnapshotKey: ownerSnapshotKey,
                        itemIndex: index,
                ...
                for (ordinal, location) in ordered.enumerated() {
                        ...
                        replacements.append(
                            PlannedReplacement(
                                report: PublicIDRepairReplacement(
                                    ...
                                    owningHerdPublicID: location.ownerHerdPublicID
                                ),
                    ...
                    candidates.append(
                        DuplicateCandidate(
                            ...
                            herdPublicID: location.ownerHerdPublicID,
                            stableRecordIdentifier: stableIdentifier,
