...
///   entity and proves a failed duplicate cannot overwrite, merge, or remint the logical entity.
/// - Phase 1 Core Data model-structure tests own physical UUID attribute requiredness, indexes, and
